...
public class betaV_calculations {
    ...
    private final double valueX1;
    private final double valueX2;

    public betaV_calculations(double[] factor1, double[] factor2, double[] yield, double valueX1, double valueX2) {
    ...
    public void func (){
        ...
        double [][] betas = beta();
        double _yield = betas[0][0] + betas[1][0]*this.valueX1 + betas[2][0] * this.valueX2;

        System.out.println("La Ecuacion del Calculo MLR: ");
        System.out.println("y = " + betas[0][0] + " + (" + betas[1][0] + " * " + this.valueX1 + ") + (" + betas[2][0] + " * " + this.valueX2 + ")");
        System.out.println("\nCon un total de: " + _yield);
